...
from market_simulator.src.cvae import CVAE
from market_simulator.src.rough_bergomi import rough_bergomi
...
class MarketGenerator:
    ...
    def _load_data(self):
        ...
        self.data = df.loc[self.start:self.end, self.ticker]
        self.windows = []
